...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 570.0, 645.0, 79.0, 22.0 ],
					"text" : "loadmess set"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 600.0, 330.0, 33.0, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 675.0, 300.0, 33.0, 42.0 ]
				}
...
,
					"patching_rect" : [ 452.25, 645.0, 100.0, 22.0 ],
					"saved_object_attributes" : 					{
						"accentcolor" : [ 0.518893, 0.518878, 0.518887, 1.0 ],
						"bgcolor" : [ 1.0, 0.999974, 0.999991, 1.0 ],
						"color" : [ 1.0, 0.385962, 0.293389, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 452.25, 690.0, 188.0, 48.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 634.0, 11.5, 99.0, 108.5 ],
					"text" : "1 Acc Gtr NTR",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 298.0, 105.0, 75.0, 22.0 ],
					"text" : "prepend line"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 433.0, 45.0, 69.0, 22.0 ],
					"text" : "r dataClock"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 298.0, 75.0, 64.0, 22.0 ],
					"text" : "snapshot~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 298.0, 45.0, 116.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 570.0, 38.0, 22.0 ],
					"text" : "play~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 214.5, 480.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 214.5, 510.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 540.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 480.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 510.0, 144.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-5",
					"justification" : 1,
					"linecolor" : [ 0.447058823529412, 0.996078431372549, 0.780392156862745, 1.0 ],
					"maxclass" : "live.line",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 840.0, 45.0, 173.0, 128.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1020.0, 45.0, 128.0, 128.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 75.0, 144.0, 22.0 ],
					"text" : "sprintf multitrackBuffer.%i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 45.0, 77.0, 22.0 ],
					"text" : "loadmess #1"
				}
